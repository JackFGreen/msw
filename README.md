...
Claude 支持为 sonnet/opus/haiku 分别指定不同模型：

```sh
msw switch claude mimo-cn --haiku mimo-v2.5
```
...
msw env --all                                 # 打印所有 active agent 的 shell exports
```
